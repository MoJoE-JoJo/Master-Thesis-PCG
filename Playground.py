...
arl_save_folder = "saved_arl/28/"
arl=None
arl = ARLPCG(
    load_path="saved_arl/28/arl-dev_56.zip", 
...
validate_arl(arl, 100, 10, "28_arl")

arl_save_folder = "saved_arl/14_2/"
arl=None
arl = ARLPCG(
    load_path="", 
    levels_path=level_folder, 
...
validate_arl(arl, 100, 10, "14_2_arl")

train(arl, 12)

validate_arl(arl, 100, 10, "14_2_arl_24")

#train(arl, 6)

#validate_arl(arl, 100, 10, "23_arl_30")
